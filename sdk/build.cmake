...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(tuya_cloud)
if (DEFINED CFG_BUILD_TUYA_CLOUD)
	target_link_libraries(${CMAKE_PROJECT_NAME} 
		${PROJECT_SOURCE_DIR}/sdk/share/tuya_cloud/lib_tuya.a
	)
endif()
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(tuya_sys)
...
#ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(iperf)
...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(non_gpl_wifi_mhd)
	...
	if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6256)
		  target_link_libraries(${CMAKE_PROJECT_NAME}
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4345x.a
		  )
	endif()

	if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6236)
		  target_link_libraries(${CMAKE_PROJECT_NAME}
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd4343x.a
		  )
	endif()

	if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6181)
		  target_link_libraries(${CMAKE_PROJECT_NAME}
            ${PROJECT_SOURCE_DIR}/sdk/driver/non_gpl_wifi_mhd/wlan_lib/libmhd43362.a
		  )
	endif()
endif()
...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(mt7682)
...
elseif ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    ...
    if (DEFINED CFG_RISC2_ENABLE)
        ...
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_RISC2_TEST_DEVICE risc2TestDevice)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_RISC2_OPUS_CODEC opuscodec)
        ITE_LINK_LIBRARY_IF_DEFINED(CFG_RISC2_SW_IRRX swIRRx)
    endif()
    ...
    if (DEFINED CFG_UPGRADE_BOOTLOADER OR DEFINED CFG_UPGRADE_IMAGE OR DEFINED CFG_UPGRADE_DATA)
        ...
        message("pkgtool -s ${CFG_UPGRADE_SD0_IMAGE_SIZE} -o ${CFG_UPGRADE_SD0_IMAGE_FILENAME} -w ${CFG_UPGRADE_FILENAME}")
            add_custom_command(
                TARGET ${CMAKE_PROJECT_NAME}
                POST_BUILD
                COMMAND pkgtool
