...
int smNetOpen(struct net_device *dev, void (*input_fn)(void *arg, void *packet, int len), void *arg)
{
    int ret = 0;
...
{
    printf("====>smNetGetDevice: %s\n", (smNetDevice == NULL) ? "NULL" : "Device Exist");
    return smNetDevice;
}
