...
{
	return 0;//register_netdevice_notifier(&rtw_ndev_notifier);
}
...
#endif
	{
		padapter->xmitThread = (void *)kthread_run(rtw_xmit_thread, padapter, "RTW_XMIT_THREAD");
