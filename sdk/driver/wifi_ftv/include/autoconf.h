...
#define ITE_WEXT_MODIFIED 0 // old(0) new(1)
#define ITE_TIMER_MODIFIED 1 // old(0) new(1)
#define ITE_EASON_MODIFIED 1
#define ITE_EASON_PACKET_PRINT 0 //close(0) Rx(1) Tx(2)
...
#define DISABLE_BB_RF	0 /* Don't define it into 1*/

#define RTW_NOTCH_FILTER 1 /* 0:Disable, 1:Enable, */
