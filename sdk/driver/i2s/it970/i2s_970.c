...
static void PLL_reset(u32 addr){
    ithWriteRegA(addr,0x80000000); 
    ithWriteRegA(addr,0xF3000000); 
    ithDelay(220);    
    ithWriteRegA(addr,0x80000000);      
}
static void _i2s_set_clock(u32 demanded_sample_rate , u8 *demanded_sample_width)
{
    ...
    */
    ...
    if(demanded_sample_rate == 32000 || demanded_sample_rate == 48000){
        //12.288 MHz
        ithWriteRegA(0xD8000118,0x20403201); 
        PLL_reset(0xD800011C);            
        ithWriteRegA(0xD8000110,0x60283201); 
        PLL_reset(0xD8000114);
    }else if(demanded_sample_rate == 44100){
        //11.2896 MHz
        ithWriteRegA(0xD8000118,0x20311901);
        PLL_reset(0xD800011C);                    
        ithWriteRegA(0xD8000110,0x60183201);
        PLL_reset(0xD8000114);
    }else{
        //12 MHz
