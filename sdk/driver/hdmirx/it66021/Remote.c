...
#ifdef Enable_IR
#pragma message("defined Enable_IR")
#endif
//****************************************************************************
// Remote.c
//
...
code BYTE IR2RCPTable[MAXKEY][MAXKEY]=
{
...
// disable ->			else
// disable ->			{
// disable ->				printf(" IRCode[0] %X\n",IRCode[0]);
// disable ->				printf(" IRCode[1] %X\n",IRCode[1]);
// disable ->			}
...
void IRHandler(void)
{
    ...
    if(g_keyQue!=NO_KEY)
    {
        IT6602_DEBUG_INT_PRINTF(("!!! IRHandler() !!!g_keyQue= %X\n", (int) g_keyQue));
        switch(g_keyQue)
        {
            case  IR_HDMI1_CODE:
                IT6602PortSelect(0);
...
//				break;
            ...
            case  IR_PWR_CODE:
                IT6602_CECPowerOffByit660x(1);
                break;

            case  IR_NO4_CODE:
                IT6602_CECPowerOnByit660x(0);
                IT6602PortSelect(0);
                break;
            case  IR_NO5_CODE:
            case  IR_NO6_CODE:
                IT6602_CECPowerOnByit660x(1);
                IT6602PortSelect(1);
                break;
    #endif
