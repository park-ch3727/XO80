...
_Cap_ColorMatrix(
    CAP_CONTEXT *Capctxt)
{
    if (Capctxt->ColorMatrixMode == RGBTOYUV_ITU601_16_235)
    { 
    ...
    else if(Capctxt->ColorMatrixMode  == RGBTOYUV_ITU601_0_255)
    {     
    ...
    {
        Capctxt->RGBtoYUVFun._11 = 0x0100;
        Capctxt->RGBtoYUVFun._12 = 0x0000;
        Capctxt->RGBtoYUVFun._13 = 0x0000;
        Capctxt->RGBtoYUVFun._21 = 0x0000;
        Capctxt->RGBtoYUVFun._22 = 0x0100;
        Capctxt->RGBtoYUVFun._23 = 0x0000;
        Capctxt->RGBtoYUVFun._31 = 0x0000;
        Capctxt->RGBtoYUVFun._32 = 0x0000;
        Capctxt->RGBtoYUVFun._33 = 0x0100;
        Capctxt->RGBtoYUVFun.ConstY = 0x0000; 
        Capctxt->RGBtoYUVFun.ConstU = 0x0000;
        Capctxt->RGBtoYUVFun.ConstV = 0x0000;          
    }
    ...
    CAPTURE_HANDLE *ptDev, CAPTURE_SETTING info)
{
	...
	printf("video_vram_addr[0x%x] , video_sys_addr = 0x%x\n", pCapctxt->video_vram_addr , pCapctxt->video_sys_addr);
	printf("Max_Width:%d , Max_Height:%d , size:%d\n",info.Max_Width, info.Max_Height , size);
    ...
    CAPTURE_HANDLE *ptDev)
{
    ...
    if (Capctxt->EnableOnflyMode == MEMORY_WITH_ONFLY_MODE)
    {
    ...
    else if (Capctxt->EnableOnflyMode == ONFLY_MODE)
    {
    ...
    _Cap_ColorMatrix(Capctxt);//Set Color matrix
