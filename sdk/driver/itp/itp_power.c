...
static void PowerStandby(void)
{
    ...
    #ifdef CFG_RTC_6_8P
    ioctl(ITP_DEVICE_RTC, ITP_IOCTL_RTC_ADJUST_DISABLE, NULL);
    #endif
...
static void PowerSleep(void)
{
    ...
    ioctl(ITP_DEVICE_ECM_EX, ITP_IOCTL_SLEEP, NULL);
    #endif
