...
int itp_usbh_init(void)
{
    ...
    if ((rc=usbh_prn_init())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_prn_init()=%d\n", rc LOG_END
        goto end;
    }
#endif
    ...
    if ((rc=usbh_rndis_init())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_rndis_init()=%d\n", rc LOG_END
        goto end;
    }
#endif
...
int itp_usbh_exit(void)
{
    ...
    if ((rc=usbh_prn_delete())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_prn_delete()=%d\n", rc LOG_END
        goto end;
    }
#endif
    ...
    if ((rc=usbh_rndis_delete())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_rndis_delete()=%d\n", rc LOG_END
        goto end;
    }
#endif
