...
#ifdef CFG_USBH_CD_PRINTER
#include "usbhcc/api/api_usbh_printer.h"
#endif
#ifdef CFG_USBH_CD_RNDIS
...
int usb_host_start(void)
{
    ...
    if (rc) {
        LOG_ERR "usbh_cdcacm_start() fail! \n" LOG_END
            goto end;
    }
#endif
    ...
    if ((rc=usbh_prn_start())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_prn_start()=%d\n", rc LOG_END
        goto end;
    }
#endif
    ...
    if ((rc=usbh_rndis_start())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_rndis_start()=%d\n", rc LOG_END
        goto end;
    }
#endif
...
int usb_host_stop(void)
{
    ...
    if ((rc=usbh_prn_stop())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_prn_stop()=%d\n", rc LOG_END
        goto end;
    }
#endif
    ...
    if ((rc=usbh_rndis_stop())!=USBH_SUCCESS)
    {
        LOG_ERR "usbh_rndis_stop()=%d\n", rc LOG_END
        goto end;
    }
#endif
