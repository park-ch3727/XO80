...
SensorDriver ithSensorCreate(uint8_t *moduleName)
{
    ...
    if (strcmp(moduleName, "TP2825.c") == 0)
        return (SensorDriver)TP2825SensorDriver_Create();
    ...
    if (strcmp(moduleName, "GC2145.c") == 0)
        return (SensorDriver)GC2145SensorDriver_Create();
