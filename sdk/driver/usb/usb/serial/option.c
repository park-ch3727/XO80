...
/* blink BL-M8910DL */
#define BLINK_VENDOR_ID		0x1782
#define BLINK_PRODUCT_M8910DL_PPP	0x4D10
#define BLINK_PRODUCT_M8910DL_ECM	0x4D11
...
static const struct option_blacklist_info fibocom_L610_blacklist = {
    .reserved = BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7),
};

static const struct option_blacklist_info blink_m8910dl_ppp_blacklist = {
	.reserved = BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7),
};

static const struct option_blacklist_info blink_m8910dl_ecm_blacklist = {
	.reserved = BIT(0) | BIT(1) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9),
};
...
static const struct usb_device_id option_ids[] = {
    ...
    /* [L610] GTUSBMODE¡G31 for windows (No RNDIS Netcard) */
    { USB_DEVICE(0x1782, 0x4d10),
        .driver_info = (unsigned long)&fibocom_L610_blacklist },
    /* [L610] GTUSBMODE¡G32 or 33 for Linux or Windows with RNDIS netcard */
    { USB_DEVICE(0x1782, 0x4d11),
        .driver_info = (unsigned long)&fibocom_L610_blacklist },
#endif
#if defined(CFG_NET_M8910DL_4G)
    /* blink M8910DL PPP */
    { USB_DEVICE_AND_INTERFACE_INFO(BLINK_VENDOR_ID, BLINK_PRODUCT_M8910DL_PPP, 0xff, 0, 0),
        .driver_info = (unsigned long)&blink_m8910dl_ppp_blacklist },
    /* blink M8910DL ECM */
    { USB_DEVICE_AND_INTERFACE_INFO(BLINK_VENDOR_ID, BLINK_PRODUCT_M8910DL_ECM, 0xff, 0, 0),
        .driver_info = (unsigned long)&blink_m8910dl_ecm_blacklist },
#endif
	{ } /* Terminating entry */
};
