...
int iteUdcSetRmWakup(void)
{
    static uint32_t rw_en = 0;
    if(itpGetTickDuration(rw_en) > 1000*3) rw_en = 0;
    
    if(rw_en == 0)
    {
        printf("iteUdcSetRmWakup *****\n");
//        printf("1. FOTG210_DMCR(%x) FOTG210_GS2R(%x)\n", ithReadRegA(UDC_BASE + FOTG210_DMCR), ithReadRegA(UDC_BASE + FOTG210_GS2R));
//        usleep(1000*1000*1); //delay 1s
        ithWriteRegMaskA(UDC_BASE + FOTG210_DMCR, 1, DMCR_CAP_RMWAKUP);
        ithWriteRegMaskA(UDC_BASE + FOTG210_GS2R, GS2R_N0USBWAKEUP, GS2R_N0USBWAKEUP);
//        printf("2. FOTG210_DMCR(%x) FOTG210_GS2R(%x)\n", ithReadRegA(UDC_BASE + FOTG210_DMCR), ithReadRegA(UDC_BASE + FOTG210_GS2R));
        usleep(1000*15);
        ithWriteRegMaskA(UDC_BASE + FOTG210_GS2R, 0, GS2R_N0USBWAKEUP);
        ithWriteRegMaskA(UDC_BASE + FOTG210_DMCR, 0, DMCR_CAP_RMWAKUP); 
        rw_en = itpGetTickCount();
//        printf("3. FOTG210_DMCR(%x) FOTG210_GS2R(%x)\n", ithReadRegA(UDC_BASE + FOTG210_DMCR), ithReadRegA(UDC_BASE + FOTG210_GS2R));
        iteUdcResetPlug();
        printf("iteUdcSetRmWakup &&&&&\n");
        return 1;
    }
