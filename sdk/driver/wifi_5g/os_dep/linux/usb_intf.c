...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	{USB_DEVICE(0x2001, 0x3316),.driver_info = RTL8812}, /* D-Link - Cameo */
        ...
        /*=== Realtek demoboard ===*/
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x0811),.driver_info = (unsigned long)RTL8821},/* Default ID */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x0821),.driver_info = (unsigned long)RTL8821},/* Default ID */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x8822),.driver_info = (unsigned long)RTL8821},/* Default ID */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0xA811) , .driver_info = (unsigned long)RTL8821},/* Default ID */
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_REALTEK, 0x0820,0xff,0xff,0xff),.driver_info = (unsigned long)RTL8821}, /* 8821AU */
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_REALTEK, 0x0823,0xff,0xff,0xff),.driver_info = (unsigned long)RTL8821}, /* 8821AU */
	/*=== Customer ID ===*/
	{USB_DEVICE(0x7392, 0xA811),.driver_info = (unsigned long)RTL8821}, /* Edimax - Edimax */
	{USB_DEVICE(0x7392, 0xA812),.driver_info = (unsigned long)RTL8821}, /* Edimax - EW-7811UTC */
	{USB_DEVICE(0x7392, 0xA813),.driver_info = (unsigned long)RTL8821}, /* Edimax - EW-7811UAC */
	{USB_DEVICE(0x0BDA, 0xA811),.driver_info = (unsigned long)RTL8821}, /* OUTLINK - Edimax */
	{USB_DEVICE(0x04BB, 0x0953),.driver_info = (unsigned long)RTL8821}, /* I-O DATA - Edimax */
	{USB_DEVICE(0x2001, 0x3314),.driver_info = (unsigned long)RTL8821}, /* D-Link - Cameo */
	{USB_DEVICE(0x2001, 0x3318),.driver_info = (unsigned long)RTL8821}, /* D-Link - Cameo */
	{USB_DEVICE(0x0E66, 0x0023),.driver_info = (unsigned long)RTL8821}, /* HAWKING - Edimax */
	{USB_DEVICE(0x056E, 0x400E) , .driver_info = (unsigned long)RTL8821}, /* ELECOM -  ELECOM */
	{USB_DEVICE(0x056E, 0x400F) , .driver_info = (unsigned long)RTL8821}, /* ELECOM -  ELECOM */
#endif
