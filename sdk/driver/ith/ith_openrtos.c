...
#if defined(CFG_GPIO_SD1_WIFI_POWER_ENABLE) && (defined(CFG_NET_WIFI_SDIO_NGPL) || defined(CFG_NET_WIFI_SDIO_NGPL_8723DS))
    ithWIFICardPowerOn();
#endif
    // init card
...
void ithCpuDoze(void)
{
  ...
  //workaround 970 CPU power saving mode problem  
	ithWriteRegMaskA(0xD8300000, 0x00010000, 0x00010000);
#endif
...
#if (CFG_CHIP_FAMILY == 970)
    //workaround 970 CPU power saving mode problem  
    ithWriteRegMaskA(0xD8300000, 0x00000000, 0x00010000);
#endif
}
