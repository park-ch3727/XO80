...
#ifndef ITU_FORCE_ROTATE_ROT0
    if (m2dRotation == rot)
        return;
#endif // !ITU_FORCE_ROTATE_ROT0
    ...
    uint8_t alpha)
{
    ...
    if (src->format == ITU_A8)
        srcSurface.srcSurface->format = GFX_COLOR_A_8;
