...
#define ITU_COMBOTABLE_MAX_ITEM_COUNT 1000
extern int ggCount;
extern int eeCount;
...
#define ITU_SURFPOOL    0x40    ///< This surface is managed under SurfacePool.
...
ITUWidget* ituListBoxGetItem(ITUListBox* listbox,int ItemIndex);	// JPHong 2023-05-02
/**
...
void ituScrollBar_SetInfo(int nTotalUser, int nPageCnt); //chpark.24.08.06
...
/**
* Clear the DrawPen widget.
*
* @param drawpen The DrawPen widget to clear.
*/
...
/**
* Add items to the list of the ComboTable widget.
* @param cbtWidget The ComboTable widget to add item.
...
/**
* Set Count of Item in 1 page at the ComboTable widget.
*
* @param nCount Count of Item.
*/
void ituComboTable_SetPageItemCount(int nCount);//chpark.24.05.20
...
typedef struct
{
	...
	uint32_t vPoolBuf;                                          ///< The share pool buffer used for surfpl.
	ITUSurface* surfpl;                                         ///< The memory pool to handle surface buffer for all display widget.
	int poolSize;                                               ///< internal usage
} ITUScene;
...
/**
 * Draw the video to the background widget.
 *
 * @param widget     The target background widget.
 * @param dest       The target surface.
 * @param startX     The x coordinate of destination surface, in pixels.
 * @param startY     The y coordinate of destination surface, in pixels.
 * @param src_width  The width of source video.
 * @param src_height The height of source video.
 * @param angle      The source video rotate degrees.
 */
