...
static void ICA_INIT(int *ICAframesize)
{
    ...
    Init_dmnr_hand_held(&dmnr_config[0]);
    Init_BSS(&bss_config[0]);
    *ICAframesize = 256;
    Cntr += 1;
}
...
static void ica_separate_process(MSFilter *f)
{
    ...
    while (ms_bufferizer_get_avail(s->dualBuf) >= nbytes * 2)
    {
        ...
        {
            *((int16_t *)(o1->b_wptr)) = (int)*(int16_t *)im->b_rptr;
            im->b_rptr += 2;
            *((int16_t *)(o2->b_wptr)) = (int)*(int16_t *)im->b_rptr;
            im->b_rptr += 2;
        }

        if (Cntr % 2 == 0)
            //ICA_Separation((short*)(o1->b_rptr), (short*)(o2->b_rptr), (short*)(o1->b_rptr), (short*)(o2->b_rptr), &ica_config[0]);
            //dmnr_hand_held((short *)(o2->b_rptr), (short *)(o1->b_rptr), (short *)(o2->b_rptr), (short *)(o1->b_rptr), &dmnr_config[0]);
            DMNR_ICA((short *)(o1->b_rptr), (short *)(o2->b_rptr), (short *)(o1->b_rptr), 0,
                     &bss_config[0]);
