...
extern SIT_SECTION_TABLE prev_sit;
static void sit_cb(MpegTSFilter *filter, const uint8_t *section, int section_len)
{
	...
	if(sit->encoder_info != MMP_CAP_INPUT_INFO_640X480_60P 
		...
		&& sit->encoder_info != MMP_CAP_INPUT_INFO_1400X1050_60P
		...
		&& sit->encoder_info != MMP_CAP_INPUT_INFO_1920X1080_24P
        && sit->encoder_info != MMP_CAP_INPUT_INFO_1920X1080_25P
        && sit->encoder_info != MMP_CAP_INPUT_INFO_1920X1080_29P
        && sit->encoder_info != MMP_CAP_INPUT_INFO_1920X1080_30P)
	{
		av_log(ts->stream, AV_LOG_INFO, "SIT TABLE: Get Not Support Resolution, sit->encoder_info = %d\n", sit->encoder_info);
		bNotSupportResolution = true;
	}

	bUpdated = ((sit->encoder_info != previous_sit->encoder_info ||  previous_sit->input_color != sit->input_color) && !bNotSupportResolution);
	...
	if (bUpdated)
	{
        ...
        previous_sit->input_color = sit->input_color;
        ...
        mtal_set_color_info((bool)sit->input_color);
