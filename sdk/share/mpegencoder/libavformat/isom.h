...
/* isom.c */
extern const AVCodecTag ff_mp4_obj_type_ex[];
extern const AVCodecTag ff_codec_movvideo_tags_ex[];
extern const AVCodecTag ff_codec_movaudio_tags_ex[];

int ff_mov_iso639_to_lang_ex(const char lang[4], int mp4);
