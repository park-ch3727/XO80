...
const mbedtls_cipher_definition_t mbedtls_cipher_definitions_ex[] =
{
#if defined(MBEDTLS_AES_C)
...
#define NUM_CIPHERS sizeof mbedtls_cipher_definitions_ex / sizeof mbedtls_cipher_definitions_ex[0]
