...
int audioFilterProcessSoundRead()
{
    ...
    if (gAudioProcess.readIdx <= pcmIdx)
    {
        ...
        if (bsize)
        {
            ...
            swap16_buff((uint16_t*)(rawBuf + gAudioProcess.readIdx), bsize>>1);
    ...
    else
    {
        ...
        if (bsize)
        {
            ...
            if (szsec0)
            {
                ...
                swap16_buff((uint16_t*)(rawBuf + gAudioProcess.readIdx), szsec0>>1);
            ...
            if (szsec1)
            {
                ...
                swap16_buff((uint16_t*)rawBuf, szsec1>>1);
