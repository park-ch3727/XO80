...
extern bool MainDispMode_PW; //  0:Multi Finger , 1:Single Finger  // JPHong 2024-11-28
...
if (MainDispMode_PW==1)	// JPHong 2023-07-28
{
	curFgr = 1;
...
#ifdef	CFG_TOUCH_MULTI_FINGER
if (MainDispMode_PW==0)	// JPHong 2023-07-28
{
