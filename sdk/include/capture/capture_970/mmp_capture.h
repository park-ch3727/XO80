...
typedef enum MMP_CAP_INPUT_INFO_TAG
{
    ...
    MMP_CAP_INPUT_INFO_1400X900_60P  = 29,
    MMP_CAP_INPUT_INFO_1440X900_60P  = 30,
    MMP_CAP_INPUT_INFO_1400X1050_60P = 31,
    MMP_CAP_INPUT_INFO_1440X1050_60P = 32,
    MMP_CAP_INPUT_INFO_1600X900_60P  = 33,
    MMP_CAP_INPUT_INFO_1600X1200_60P = 34,
    MMP_CAP_INPUT_INFO_1680X1050_60P = 35,
    MMP_CAP_INPUT_INFO_ALL           = 36,
    MMP_CAP_INPUT_INFO_NUM           = 37,
    MMP_CAP_INPUT_INFO_UNKNOWN       = 38,
    MMP_CAP_INPUT_INFO_CAMERA        = 39,
} MMP_CAP_INPUT_INFO;
...
typedef struct CAPTURE_SETTING_TAG
{
	...
	MMP_UINT8 OnflyMode_en; /*0: memory mode 1: onfly mode 2:onfly with memory*/
...
//=============================================================================
/**
 * Capture SearchClkDelay
 */
//=============================================================================
CAP_API void
ithCapSearchClkDelay(
    CAPTURE_HANDLE *ptDev);
