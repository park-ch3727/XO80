...
// The API for adjusting the drive strength of GPIO with 4 levels is detailed below.
// Use this function to set the desired driving strength for each GPIO pin.
// 2024-10-18 E-Mail 
typedef enum
{
    ITH_GPIO_DRIVING_0 = 0,  // <2mA
    ITH_GPIO_DRIVING_1 = 1,  // 2mA
    ITH_GPIO_DRIVING_2 = 2,  // 4mA (default)
    ITH_GPIO_DRIVING_3 = 3   // 6mA
} ITHGpioDriving;
