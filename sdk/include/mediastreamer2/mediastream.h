...
MS2_PUBLIC VideoStream *cam_playback_start(bool_t with_preview, bool_t memory_mode);
MS2_PUBLIC void cam_playback_stop(VideoStream *stream, bool_t with_preview);
MS2_PUBLIC VideoStream *cam_playback_with_rec_start();
MS2_PUBLIC void cam_playback_with_rec_stop(VideoStream *stream);
MS2_PUBLIC void cam_playback_snapshot(char *file);
...
MS2_PUBLIC int video_stream_udp_start(VideoStream *stream, Call_info *call_list, int rem_port,
