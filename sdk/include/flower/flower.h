...
typedef enum _IteMethodId {
	...
	ITE_FILTER_ISP_SETOUTPUT,
	ITE_FILTER_ISP_SETINPUTMODE,
	ITE_FILTER_ENC_SETINPUT,
	ITE_FILTER_ENC_SETMOBILE,
	ITE_FILTER_OSD_SETINPUT,
	ITE_FILTER_OSD_SETMODE,
	ITE_FILTER_JPEG_SNAPSHOT,
	ITE_FILTER_REC_AVI_OPEN,
	ITE_FILTER_REC_AVI_OPEN_PARTIAL,
	ITE_FILTER_REC_AVI_CLOSE,
	ITE_FILTER_QR_SETINPUT,
	ITE_FILTER_QR_GETPAYLOAD,
	ITE_FILTER_QR_GETPAYLOADSIZE,
    /*audio*/
...
typedef enum _IteVideoFrameRate
{
    VIDEO_FRAMERATE_UNKNOW = 0,
    VIDEO_FRAMERATE_25HZ,
    VIDEO_FRAMERATE_50HZ,
    VIDEO_FRAMERATE_30HZ,
    VIDEO_FRAMERATE_60HZ,
    VIDEO_FRAMERATE_29_97HZ,
    VIDEO_FRAMERATE_59_94HZ,
    VIDEO_FRAMERATE_23_97HZ,
    VIDEO_FRAMERATE_24HZ,
    VIDEO_FRAMERATE_56HZ,
    VIDEO_FRAMERATE_70HZ,
    VIDEO_FRAMERATE_72HZ,
    VIDEO_FRAMERATE_75HZ,
    VIDEO_FRAMERATE_85HZ,
    VIDEO_FRAMERATE_VESA_30HZ,
    VIDEO_FRAMERATE_VESA_60HZ
} IteVideoFrameRate;
...
typedef struct _IteVideoFlower {
	...
	IteFilter *Ftcpsend;
    IteFilter *Ftcprecv;
	IteFilter *Fqrscanner;
    IteFChain fc;
    ISPOutPutStream ISPout;
}IteVideoFlower;
