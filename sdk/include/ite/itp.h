...
/** @addtogroup itp_memleak Memory Leak Tool
 *  @{
 *  How to use it:
...
typedef enum
{
    ...
    ITP_DEVICE_IR            = (15 << ITP_DEVICE_BIT),       ///< IR0
    ...
    ITP_DEVICE_IR1           = (80 << ITP_DEVICE_BIT),       ///< IR1
    ITP_DEVICE_IR2           = (81 << ITP_DEVICE_BIT),       ///< IR2
    ITP_DEVICE_IR3           = (82 << ITP_DEVICE_BIT),       ///< IR3
    ITP_DEVICE_WIFI_NGPL     = (83 << ITP_DEVICE_BIT),       ///< WiFi SDIO NGPL
    ITP_DEVICE_USBDHID       = (84 << ITP_DEVICE_BIT),       ///< USB acts as a USB HID device
	ITP_DEVICE_USBOPTION 	 = (85 << ITP_DEVICE_BIT),		 ///< USB Option for 4G modem AT command
#if defined(CFG_USBH_CD_CDCACM)
    ITP_DEVICE_USBHACM = ITP_DEVICE_USBOPTION,         ///< USB Host CDCACM/OPTION
#endif
    ITP_DEVICE_USBDNCM		 = (86 << ITP_DEVICE_BIT),		 ///< USB Network Control Model
    ITP_DEVICE_ECM_EX        = (87 << ITP_DEVICE_BIT),		 ///< USB CDC Ethernet
	ITP_DEVICE_SYS_PARAM	 = (88 << ITP_DEVICE_BIT),       ///< TUYA System param
    ITP_DEVICE_LAST
} ITPDeviceType;
...
#define ITP_IOCTL_SET_MODE            100  ///< Set decompress mode(0:UCL 1:SPEEDY 2:SPEEDY_COMPRESSION)
#define ITP_IOCTL_SET_BYTE_PER_PIXEL  101  ///< Set decompress mode(SPEEDY_COMPRESSION 1:1-BYTE/PIXEL 2:2-BYTE/PIXEL 4:4-BYTE/PIXEL)
...
#define ITP_IOCTL_AT_CMD              120  ///< Process AT Cmd
#define ITP_IOCTL_WIFI_HIDDEN_SSID    121  ///< Connect to hidden SSID
#define ITP_IOCTL_ERASE               122  ///< Storage erase
#define ITP_IOCTL_RTC_ADJUST_DISABLE  123  ///< Stop AdjustRTC task
#define ITP_IOCTL_READ_PARAM          128
#define ITP_IOCTL_WRITE_PARAM         129
#define ITP_IOCTL_NETIF_ADD           130  ///< Add and bring netif up
#define ITP_IOCTL_NETIF_REMOVE        131  ///< Down and remove a netif
...
extern const ITPDevice   itpDeviceUsbEcmex;       ///< USB CDC Ethernet
extern const ITPDevice   itpDeviceSysParam;       ///< TUYA Sys parm
extern const ITPDevice   itpDeviceUsbhAcm;        ///< USB Host CDCACM/OPTION
...
typedef struct
{
    ...
    #define ITP_FAT_EXBR_PATH_SIZE 32                  // < 32 byte length of file path.
...
/**
 * Adjust RTC for sleep mode.
 */
void RtcAdjustInitTask(void *);

/**
 * Initializes Auto-Ajust RTC.
 */
void itpRtcAdjustInit(void);

/**
 * Stop Auto-Ajust RTC task.
 */
