...
void ConfigInit(void)
{
	...
	strncpy(theConfig.version, iniparser_getstring(cfgIni, "sports_equipment:swversion", "0.0.0.0"), sizeof (theConfig.version) - 1);
	theConfig.is_first_boot = iniparser_getboolean(cfgIni, "sports_equipment:firstboot", 0);
...
static void ConfigSavePublic(void)
{
	...
	iniparser_set(cfgIni, "sports_equipment:swversion", theConfig.version);
	iniparser_set(cfgIni, "sports_equipment:firstboot", theConfig.is_first_boot ? "y" : "n");
