...
bool ModeSpriteDemo(int time)// change in each 600ms 
{
//	return true;
	static int frame = 0;
...
bool GearSpriteDemo(int time)// change in each 600ms 
{
//	return true;
	static int frame = 0;
	static int pre_frame = 0;
...
bool DirectionSpriteDemo(int time)//change in each 800ms
{
//	return true;
	static int pre_frame = 0;
	bool ret = false;
