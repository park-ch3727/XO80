...
void ConfigInit(void)
{
	...
	screenSaverType = theConfig.screensaver_type;
    ...
    theConfig.keylevel = iniparser_getint(cfgIni, "ctrlboard:keylevel", 20);
    theConfig.audiolevel = iniparser_getint(cfgIni, "ctrlboard:audiolevel", 20);
