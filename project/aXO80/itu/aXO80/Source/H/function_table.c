...
extern bool RTBGOnEnter(ITUWidget* widget, char* param);
extern bool RTBGOnTimer(ITUWidget* widget, char* param);
extern bool RTBGOnLeave(ITUWidget* widget, char* param);
...
ITUActionFunction actionFunctions[] =
{
    ...
    "RTBGOnEnter", RTBGOnEnter,
    "RTBGOnTimer", RTBGOnTimer,
    "RTBGOnLeave", RTBGOnLeave,
